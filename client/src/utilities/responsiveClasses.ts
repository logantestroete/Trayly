...
export const spacing = {
    pageX: "px-[clamp(1rem,4vw,3rem)]",
    sectionY: "py-[clamp(1rem,3vw,2.5rem)]",
    cardPadding: "p-[clamp(1rem,2vw,1.5rem)]",
    cardGap: "gap-[clamp(0.75rem,2vw,1.5rem)]",
    stackGap: "space-y-[clamp(0.75rem,2vw,1.25rem)]",
}
